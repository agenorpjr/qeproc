...
const mockdata = [
  {
    links: [
      ...
      { label: 'Requisições', icon: IconFoldersFilled, link: "/admin/orders"},
      { label: 'Novo Usuário', icon: IconClipboardPlus, link: "/sign-up" },
      { label: 'Gerenciar Compradores', icon: IconClipboardPlus, link: "/admin/purchaser" },
      { label: 'Gerenciar Aprovadores', icon: IconClipboardPlus, link: "/admin/approver" },
      { label: 'Configurações', icon: IconUserCode, link: '/admin/settings' },
