...
import { ActionIcon, Box, Button, Card, Pill, Divider, Flex, Grid, Group, Modal, Stack, Title, Text, Tooltip, TextInput, NumberInput } from '@mantine/core';
          ...
          },
          {
            ...
            render: (record) => (
              <Group gap={4} justify="right" wrap="nowrap">
                <Pill size="sm" color='teal' onClick={(e: React.MouseEvent) => {
                  e.stopPropagation()
                }} className={classes.pill}>{record.status}</Pill>
              </Group>
